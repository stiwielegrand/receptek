...
$receptnev = $elkeszites = $alapanyag = $link ="";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
            ...
            {
                echo "Hiba, valami hiányzik! <br>".$nevhiba."<br>".$elkesziteshiba;
            }
    }
?>
                ...
                <section class="spotlight style1 orient-right content-align-left image-position-center onscroll-image-fade-in" id="first">
                    ...
                    <div class="content">
                        ...
                        <div class="input_fields_wrap">
                            ...
                            <div><label for="name">Hozzávaló:</label><input type="text" name="hozzavalo[]"></div>
                        </div>
                    </div>
                </section>
